...
const STEPS = [
  ...
  },
  {
    ...
    detail: 'Δεν απαιτείται καμία τεχνική γνώση.',
  },
]
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-2">
            ...
            {[
              ...
              { dot: '#f87171', text: 'Αλέξης Κ. — εκκρεμεί πληρωμή', time: 'πριν 1ω' },
  ...
  return (
    <div className="min-h-screen text-white" style={{ background: '#07070f' }}>
      ...
      <section className="relative overflow-hidden px-6 md:px-10 pt-20 md:pt-28 pb-20">
        ...
        <div className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-14 lg:gap-16">
          ...
          <div className="flex-1 max-w-2xl">
            {/* Pill badge */}
            <div
              className="animate-fade-up inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 text-xs font-medium mb-7"
              style={{
            ...
            >
              ...
              Τώρα σε δοκιμαστική πρόσβαση · 120+ σύλλογοι
            </div>
            ...
            <p
              ...
              style={{ color: 'rgba(255,255,255,0.5)' }}
            >
              Το Koinon δίνει σε κάθε σύλλογο έναν ιδιωτικό χώρο — λίστες μελών, εβδομαδιαία
              προγράμματα, παρακολούθηση πληρωμών και άμεσες ανακοινώσεις. Φτιαγμένο για
              διαχειριστές που θέλουν να λειτουργεί.
            </p>
            ...
            <div className="animate-fade-up-4 flex flex-wrap items-center gap-4">
              ...
              >
                Αποκτήστε δοκιμαστική πρόσβαση
                <IconArrow />
              </a>
              <a
                href="#how"
          ...
          {[...CLUB_TYPES, ...CLUB_TYPES].map((type, i) => (
            ...
            >
              <span
                ...
                style={{
                  background: i % 3 === 0 ? '#818cf8' : i % 3 === 1 ? '#34d399' : '#fbbf24',
                }}
              />
              {type}
            </span>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-2xl mb-16">
            ...
            <p className="text-base leading-relaxed" style={{ color: 'rgba(255,255,255,0.45)' }}>
              Σχεδιασμένο για τοπικούς συλλόγους. Χωρίς περιττές λειτουργίες. Χωρίς εταιρική
              τιμολόγηση. Μόνο τα έξι πράγματα που πραγματικά μετράνε.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {FEATURES.map((f) => (
              <div key={f.title} className="feature-card glass rounded-2xl p-6">
                <div
      ...
      <section id="pricing" className="px-6 md:px-10 py-28">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-12" style={{ color: 'rgba(255,255,255,0.45)' }}>
            Βρισκόμαστε σε δοκιμαστική πρόσβαση — η τιμολόγηση οριστικοποιείται. Εγγραφείτε τώρα και
            κλειδώστε την τιμή σας.
          </p>
            ...
            <div className="relative grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-sm mb-8" style={{ color: 'rgba(255,255,255,0.4)' }}>
                  Πλήρης πρόσβαση. Χωρίς πιστωτική κάρτα. Κλειδώστε την τιμή σας πριν την
                  κυκλοφορία.
                </p>
                <a
                  href="#contact"
      ...
      <section
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(99,102,241,0.12) 0%, rgba(139,92,246,0.08) 50%, rgba(7,7,15,0) 100%)',
          borderTop: '1px solid rgba(255,255,255,0.06)',
        }}
      >
        {/* bg orb */}
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <h2
            ...
            style={{ fontFamily: 'var(--font-bricolage)', color: '#f1f5f9' }}
          >
            Έτοιμοι να δώσετε στον σύλλογό σας
            <br />
            <span className="text-gradient">έναν επίσημο χώρο;</span>
          </h2>
          <p className="text-lg mb-10" style={{ color: 'rgba(255,255,255,0.45)' }}>
            Εγγραφείτε στην δοκιμαστική πρόσβαση και αποκτήστε τα πάντα δωρεάν κατά τη διάρκεια της beta.
      ...
      >
        ...
        <nav className="flex items-center gap-6 text-xs" style={{ color: 'rgba(255,255,255,0.3)' }}>
          ...
          <a href="mailto:create@thetailor.gr" className="hover:text-white transition-colors">
            Επικοινωνία
          </a>
        </nav>
